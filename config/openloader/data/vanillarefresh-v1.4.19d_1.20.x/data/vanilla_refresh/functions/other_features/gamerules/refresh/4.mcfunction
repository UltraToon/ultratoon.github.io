...
execute if score cyclestats refresh_settings matches 0 run tellraw @s [{"translate": "  ","color": "gray"},{"translate":"below_name Display: ","color":"gray"},{"score":{"name": "cyclestats","objective": "refresh_settings"},"color": "yellow"}]
execute if score cyclestats refresh_settings matches 1 run tellraw @s [{"translate": "  ","color": "gray"},{"translate":"below_name Display: ","color":"gray"},{"score":{"name": "cyclestats","objective": "refresh_settings"},"color": "yellow"},{"translate": " - Cycle Stats","color": "yellow"}]
execute if score cyclestats refresh_settings matches 2 run tellraw @s [{"translate": "  ","color": "gray"},{"translate":"below_name Display: ","color":"gray"},{"score":{"name": "cyclestats","objective": "refresh_settings"},"color": "yellow"},{"translate": " - Hours","color": "yellow"}]
execute if score cyclestats refresh_settings matches 3 run tellraw @s [{"translate": "  ","color": "gray"},{"translate":"below_name Display: ","color":"gray"},{"score":{"name": "cyclestats","objective": "refresh_settings"},"color": "yellow"},{"translate": " - Health","color": "yellow"}]
execute if score cyclestats refresh_settings matches 4 run tellraw @s [{"translate": "  ","color": "gray"},{"translate":"below_name Display: ","color":"gray"},{"score":{"name": "cyclestats","objective": "refresh_settings"},"color": "yellow"},{"translate": " - Mob Kills","color": "yellow"}]
execute if score cyclestats refresh_settings matches 5 run tellraw @s [{"translate": "  ","color": "gray"},{"translate":"below_name Display: ","color":"gray"},{"score":{"name": "cyclestats","objective": "refresh_settings"},"color": "yellow"},{"translate": " - Player Kills","color": "yellow"}]
execute if score cyclestats refresh_settings matches 6 run tellraw @s [{"translate": "  ","color": "gray"},{"translate":"below_name Display: ","color":"gray"},{"score":{"name": "cyclestats","objective": "refresh_settings"},"color": "yellow"},{"translate": " - Deaths","color": "yellow"}]
execute if score cyclestats refresh_settings matches 7 run tellraw @s [{"translate": "  ","color": "gray"},{"translate":"below_name Display: ","color":"gray"},{"score":{"name": "cyclestats","objective": "refresh_settings"},"color": "yellow"},{"translate": " - Hours Survived","color": "yellow"}]
execute if score cyclestats refresh_settings matches 8 run tellraw @s [{"translate": "  ","color": "gray"},{"translate":"below_name Display: ","color":"gray"},{"score":{"name": "cyclestats","objective": "refresh_settings"},"color": "yellow"},{"translate": " - XP Level","color": "yellow"}]
execute if score cyclestats refresh_settings matches 9 run tellraw @s [{"translate": "  ","color": "gray"},{"translate":"below_name Display: ","color":"gray"},{"score":{"name": "cyclestats","objective": "refresh_settings"},"color": "yellow"},{"translate": " - Member ID","color": "yellow"}]
