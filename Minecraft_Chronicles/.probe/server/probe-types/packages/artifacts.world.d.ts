...
import {$CampsiteFeatureConfiguration, $CampsiteFeatureConfiguration$Type} from "packages/artifacts/world/$CampsiteFeatureConfiguration"
...
export class $CampsiteFeature extends $Feature<($CampsiteFeatureConfiguration)> {
...
declare module "packages/artifacts/world/$CampsiteFeatureConfiguration" {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $CampsiteFeatureConfiguration$Type = ($CampsiteFeatureConfiguration);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $CampsiteFeatureConfiguration_ = $CampsiteFeatureConfiguration$Type;
}}
