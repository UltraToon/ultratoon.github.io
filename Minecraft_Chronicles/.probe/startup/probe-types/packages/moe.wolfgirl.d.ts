...
declare module "packages/moe/wolfgirl/probejs/generated/registry/fallingtrees/TreeRegistry" {
import {$RegistryEventJS, $RegistryEventJS$Type} from "packages/dev/latvian/mods/kubejs/registry/$RegistryEventJS"
import {$Object, $Object$Type} from "packages/java/lang/$Object"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class TreeRegistry extends $RegistryEventJS<($Object)> {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type TreeRegistry$Type = (TreeRegistry);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type TreeRegistry_ = TreeRegistry$Type;
}}
...
declare module "packages/moe/wolfgirl/probejs/generated/registry/witherstormmod/SymbiontSpells" {
import {$RegistryEventJS, $RegistryEventJS$Type} from "packages/dev/latvian/mods/kubejs/registry/$RegistryEventJS"
import {$Object, $Object$Type} from "packages/java/lang/$Object"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class SymbiontSpells extends $RegistryEventJS<($Object)> {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type SymbiontSpells$Type = (SymbiontSpells);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type SymbiontSpells_ = SymbiontSpells$Type;
}}
